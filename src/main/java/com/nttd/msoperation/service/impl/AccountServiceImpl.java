...
public class AccountServiceImpl implements AccountService {
    ...
    public ResponseDto getAllAccount() {
        try {
            ...
            if (listaccount.size() == 0)
                ...
                return new ResponseDto(200, mensajeGeneral, listaccount);
    ...
    public ResponseDto addAccount(AccountDto accountDto) {
        try {
            ...
            if (customerResponse.getCode() == Response.Status.CREATED.getStatusCode() ||
                ...
                return new ResponseDto(customerResponse.getCode(), customerResponse.getErrorMessage(),
                        customerResponse.getDescription());
            ...
            if (acEntity.getFlag_creation().equals("TC")) {
                ...
                if (bankCardResponse.getCode() == Response.Status.CREATED.getStatusCode())
                    ...
                    return new ResponseDto(bankCardResponse.getCode(), bankCardResponse.getErrorMessage(),
                            bankCardResponse.getDescription());
                ...
                if (bankCardResponse.getCode() == Response.Status.CREATED.getStatusCode())
                    ...
                    return new ResponseDto(400, exceptionGeneral, "Error en registrar la tarjeta.");
            }
    ...
    public ValidationDebitDto isDebit(long IdBANKCARD) {
        ...
        if (accountEntity != null && accountEntity.getFlag_creation().equals("TD")
            ...
            validation.setCurrent_amount(accountEntity.getCurrent_amount());
            validation.setFlag_creation(accountEntity.getFlag_creation());
            validation.setIdBANKCARD(accountEntity.getIdBANKCARD());
            validation.setState(accountEntity.getState());
        } else {
            validation.setRespuesta(false);
        }
        return validation;
    }
